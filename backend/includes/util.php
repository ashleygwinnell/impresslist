...
function meta_start() {
	$GLOBALS['meta'] = [];
	$GLOBALS['meta']['start'] = microtime_float();
}
function meta_result() {
	$GLOBALS['meta']['end'] = microtime_float();
	$GLOBALS['meta']['time'] = ($GLOBALS['meta']['end'] - $GLOBALS['meta']['start']);

	unset($GLOBALS['meta']['start']);
	unset($GLOBALS['meta']['end']);
	return $GLOBALS['meta'];
}
